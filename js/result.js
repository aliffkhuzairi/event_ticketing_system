...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const applyFilter = document.getElementById('applyFilters'); // "Apply Filters" button

    // Function to open the filter dropdown
    function openFilters() {
        filtersContent.classList.add('active');
        filterOverlay.classList.add('active');
        toggleFiltersButton.style.display = 'none'; // Hide "Filters" button
    }
    ...
    function closeFilters() {
        ...
        toggleFiltersButton.style.display = 'block'; // Show "Filters" button
    }

    // Open the filters dropdown
    toggleFiltersButton.addEventListener('click', openFilters);

    // Close the filters dropdown using the "X" button
    closeFiltersButton.addEventListener('click', closeFilters);

    // Close the dropdown when clicking on the overlay
    filterOverlay.addEventListener('click', closeFilters);

    // Close the dropdown when "Apply Filters" is clicked
